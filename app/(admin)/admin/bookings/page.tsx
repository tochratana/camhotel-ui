...
export default function AdminBookingsPage() {
  ...
  const handleUpdateStatus = async (booking: BookingResponse) => {
    ...
    try {
      ...
      setFeedback(`Booking #${booking.id} updated to ${toTitleCase(nextStatus)}.`);
    } catch (error) {
        ...
        <div className="flex flex-col gap-6 h-full px-4 py-6 lg:px-6 lg:py-8 pb-20">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Full booking visibility across all customers and rooms.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {bookingsQuery.isError ? (
                <div className="rounded-md border border-destructive/40 px-3 py-2 text-sm text-destructive">
                  Failed to load admin bookings from backend.
                </div>
              ) : null}
            </CardContent>
          </Card>
