    ...
    return (
        <div className="min-h-screen  font-sans text-[#1a1b21] dark:text-[#f1f0f7] transition-colors duration-300">
            <main className="pt-24 pb-16">
                {/* Hero Section */}
                <section
                    className="max-w-7xl mx-auto px-8 py-14 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100 fill-mode-both">
                ...
                Connect With Us
                  ...
                  curated hospitality.
                            ...
                            <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                                ...
                                every detail of your stay in the Kampot District is perfected.
                            </p>
                        </div>
                    ...
                    {/* Bento Contact Grid */}
                    <div
                        className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-16 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300 fill-mode-both">
                        {/* Contact Form Card */}
                        <div
                            ...
                            <form className="space-y-6" onSubmit={handleSubmit}>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label
                                            className="text-[0.65rem] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                                            Full Name
                                        </label>
                                        <input
                                            type="text"
                        ...
                        <div className="lg:col-span-5 flex flex-col gap-6">
                            ...
                            <div
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h3 className="text-xl font-bold mb-2">Institute of Science and Technology Advanced
                                        Development</h3>
                                    <a href="https://maps.app.goo.gl/FJRVSRLDu8q92GTg7" target="_blank">
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div
                                    ...
                                    <span
                                        className="text-[0.6rem] font-bold uppercase text-slate-500 dark:text-slate-400 mb-1">
                    Phone
                  </span>
                                    <a href="tel:+85595990910" target="_blank">
                    ...
                    Email
                            ...
                            {/* Embedded Map */}
                            <div
                                className="rounded-xl overflow-hidden grow min-h-60 relative border dark:border-white/5 bg-slate-200 dark:bg-input-bg">
                                <iframe
                    ...
                    {/* FAQs Section */}
                    <section
                        className="mt-24 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500 fill-mode-both">
