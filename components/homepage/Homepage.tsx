...
export default function Homepage() {
    return (
        <main className="bg-[#faf8ff] min-h-screen font-sans selection:bg-[#dce1ff]">
            {/* Hero Section */}
            <header className="relative h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-6 max-w-4xl">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a href="#rooms"
                           className="w-full sm:w-auto bg-white text-[#00236f] px-10 py-4 rounded-xl font-bold uppercase tracking-widest text-sm hover:bg-[#dce1ff] transition-colors shadow-xl">
                            Explore Rooms
                        </a>
            ...
            <section id="about" className="py-24 px-8">
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                    <div className="relative">
                        ...
                        <div
                            className="absolute -bottom-6 -right-6 bg-[#1e3a8a] p-8 rounded-xl shadow-xl hidden lg:block">
                            <p className="text-white font-bold text-4xl italic">35+</p>
                            <p className="text-[#dce1ff] text-xs uppercase tracking-widest">Years of Excellence</p>
                        </div>
                    </div>
                    <div className="space-y-8">
                        <div className="space-y-2">
                            <span
                                className="text-[#00236f] text-xs font-bold tracking-[0.2em] uppercase">Our Heritage</span>
                        ...
                        <div className="grid grid-cols-2 gap-8 pt-4">
                            <div className="space-y-2">
                                <ConciergeBell className="text-[#00236f] w-8 h-8"/>
                                <h4 className="font-bold text-slate-900">Bespoke Concierge</h4>
                                <p className="text-sm text-slate-500">Personalized attention to your every request,
                                    24/7.</p>
                            </div>
                            <div className="space-y-2">
                                <Utensils className="text-[#00236f] w-8 h-8"/>
                                <h4 className="font-bold text-slate-900">Fine Dining</h4>
                                <p className="text-sm text-slate-500">World-class culinary experiences crafted by master
                                    chefs.</p>
                            </div>
                        </div>
                    </div>
            ...
            {/* Rooms Section */}
            <section id="rooms" className="py-24 px-8 bg-[#f4f3fa]">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                        <div className="max-w-xl">
                            <span
                                className="text-[#4b1c00] text-xs font-bold tracking-[0.2em] uppercase">Accommodations</span>
                            <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mt-2">Curated
                                Sanctuaries</h2>
                        </div>
                        <p className="text-slate-500 text-sm italic">Booking available after login</p>
                    </div>
            ...
            <section id="contact" className="py-24 px-8">
                <div className="max-w-7xl mx-auto">
                    <div
                        className="bg-white rounded-2xl shadow-sm flex flex-col lg:flex-row overflow-hidden border border-slate-100">
                        <div className="lg:w-1/3 bg-[#1e3a8a] p-12 text-white">
                            <h2 className="font-extrabold text-3xl mb-8">Get in Touch</h2>
                            <ul className="space-y-8">
                                <li className="flex items-start gap-4">
                                    <MapPin className="text-[#dce1ff]"/>
                                    <div>
                        ...
                        <div className="lg:w-2/3 p-12">
                            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <input
                                    className="w-full bg-slate-50 border-none rounded-lg p-4 focus:ring-2 focus:ring-[#00236f]"
                                    placeholder="Full Name"/>
                                <input
                                    className="w-full bg-slate-50 border-none rounded-lg p-4 focus:ring-2 focus:ring-[#00236f]"
                                    placeholder="Email Address"/>
                                <textarea
                                    className="col-span-2 w-full bg-slate-50 border-none rounded-lg p-4 focus:ring-2 focus:ring-[#00236f]"
                                    rows={4} placeholder="How can we assist you?"></textarea>
                                <button
                                    className="bg-[#00236f] text-white px-10 py-4 rounded-xl font-bold uppercase tracking-widest text-sm transition-all hover:bg-[#1e3a8a]">
                                    Send Message
                                </button>
                            </form>
                        </div>
