...
export default function RoomCard({title, tag, image, description, isVip, href = "/rooms"}: RoomCardType) {
    return (
        <div
            ...
            <div className="p-6">
                ...
                <Link href={href}
                    className="block w-full py-3 border border-card-border rounded-lg font-bold text-xs uppercase tracking-widest text-[#00236f] dark:text-blue-300 hover:bg-[#00236f] dark:hover:bg-blue-600 hover:text-white dark:hover:text-white transition-colors text-center">
                    View Details
                </Link>
            </div>
        </div>
