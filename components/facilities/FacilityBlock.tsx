        ...
        <main className="pt-32 pb-16">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              ...
              <div className="max-w-xs">
                <p className="text-[#444651] dark:text-[#c5c5d3] leading-relaxed border-l-2 border-[#d0d8ff] pl-4">
                  A curated ecosystem of luxury, designed to facilitate your
                  peace of mind and provide unparalleled comfort.
                </p>
              </div>
            </div>
          </header>
          ...
          <section className="max-w-7xl mx-auto px-8 space-y-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
              <div className="md:col-span-7 aspect-16/10 md:aspect-video overflow-hidden rounded-2xl bg-slate-200 dark:bg-slate-800">
                <Image
              ...
              <div className="md:col-span-5 space-y-6">
                ...
                <p className="text-[#444651] dark:text-[#c5c5d3] text-lg">
                  Our rooms feature Italian marble, custom linens, and
                  smart-room technology.
                </p>
                <div className="flex flex-wrap gap-3">
                  <div className="flex items-center gap-2 bg-[#dce1ff] dark:bg-[#4059aa] rounded-2xl px-4 py-2">
                    <span className="material-symbols-outlined text-[#1e3a8a] dark:text-[#b6c4ff]">
                      <LucideBedDouble className="font-bold" size={20} />
                    </span>
                    <span className="text-sm font-medium">King Size</span>
                  </div>
                  <div className="flex items-center gap-2 bg-[#dce1ff] dark:bg-[#4059aa] rounded-2xl px-4 py-2">
                    <span className="material-symbols-outlined text-[#1e3a8a] dark:text-[#b6c4ff]">
                      <LucideWifi className="font-bold" size={20} />
                    </span>
                    <span className="text-sm font-medium">Smart Controls</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="absolute inset-0 bg-linear-to-t md:bg-linear-to-r from-black/80 via-black/40 to-transparent flex items-end md:items-center p-8 md:p-16">
                <div className="max-w-lg text-white space-y-4">
                  ...
                  <p className="text-slate-300 text-lg hidden sm:block">
                    Experience the city from above in our temperature-controlled
                    rooftop pool.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pt-8">
              <div className="md:col-span-4 p-8 rounded-xl flex flex-col justify-center bg-card-bg">
                ...
                <p className=" leading-relaxed mb-8">
                  Experience a culinary journey led by world-renowned chefs at
                  our Michelin-starred restaurant &apos;The Azure&apos;.
                </p>
                <button className="flex items-center gap-2 font-bold hover:translate-x-2 transition-all text-text-card-footer">
                  Reserve a Table{" "}
                  <span className="material-symbols-outlined text-text-card-footer">
            ...
            <div className="bg-[#f4f3fa] dark:bg-[#6D7698] rounded-3xl p-10 md:p-16 border border-transparent dark:border-slate-700">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
                {[
                  ...
                  <div key={item.title} className="text-center group">
                    <div className="w-16 h-16 bg-[#dce1ff] dark:bg-[#4059aa] rounded-2xl flex items-center justify-center mx-auto mb-4 text-[#00236f] dark:text-white group-hover:rotate-12 transition-transform">
