...
import { LucideChevronDown, LucideChevronLeft, LucideChevronRight, LucideSearch, LucideStar } from "lucide-react";
      ...
      <div className="pt-24 pb-20">
        ...
        <section className="max-w-7xl mx-auto px-6 py-12 md:py-20 flex flex-col items-center text-center">
          ...
          <p className="max-w-2xl text-[#444651] dark:text-slate-300 text-lg leading-relaxed">
            Discover a curated collection of spaces designed for rest,
            productivity, and inspiration. From cozy singles to expansive
            penthouses.
          </p>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-6 mb-16">
          <div className="bg-white dark:bg-slate-900 p-4 md:p-6 rounded-2xl shadow-sm border border-[#c5c5d3]/30 dark:border-slate-800 flex flex-col lg:flex-row items-center gap-4">
            <div className="relative w-full lg:flex-1">
              <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-[#757682] dark:text-slate-400">
                <LucideSearch className="text-sm" />
              </span>
              <input
            ...
            <div className="flex flex-col md:flex-row gap-4 w-full lg:w-auto">
              <div className="relative w-full md:w-48">
                ...
                <span className="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-[#757682] dark:text-slate-400">
                  <LucideChevronDown className="text-sm" />
                </span>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex items-center text-[#6e2c00] dark:text-amber-400">
                    ...
                    >
                      <LucideStar className="text-sm" />
                    </span>
                    <span className="text-sm font-bold ml-1">4.9</span>
                  </div>
                </div>
                <p className="text-sm text-[#444651] dark:text-slate-400 mb-4">
                  Panoramic views and bespoke furnishings for the discerning
                  traveler.
                </p>
                <div className="flex gap-4 mb-6 flex-wrap">
                  <div className="flex items-center text-[#757682] dark:text-slate-400 text-xs">
            ...
            <article className="group bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl dark:border dark:border-slate-800 transition-all duration-500">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-[#444651] dark:text-slate-400 mb-4">
                  A tranquil escape featuring a private terrace and premium
                  amenities.
                </p>
                <div className="flex gap-4 mb-6 flex-wrap">
                  <div className="flex items-center text-[#757682] dark:text-slate-400 text-xs">
            ...
            <article className="group bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl dark:border dark:border-slate-800 transition-all duration-500">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-[#444651] dark:text-slate-400 mb-4">
                  Modern minimalism meets ultimate comfort for city explorers.
                </p>
                <div className="flex gap-4 mb-6 flex-wrap">
                  <div className="flex items-center text-[#757682] dark:text-slate-400 text-xs">
                    <span className="material-symbols-outlined text-sm mr-1">
            ...
            <article className="group bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl dark:border dark:border-slate-800 transition-all duration-500">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-[#444651] dark:text-slate-400 mb-4">
                  Intimate and efficient space perfect for solo business
                  travelers.
                </p>
                <div className="flex gap-4 mb-6 flex-wrap">
                  <div className="flex items-center text-[#757682] dark:text-slate-400 text-xs">
            ...
            <article className="group bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl dark:border dark:border-slate-800 transition-all duration-500">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-[#444651] dark:text-slate-400 mb-4">
                  A palatial experience featuring dedicated butler service and
                  private dining.
                </p>
                <div className="flex gap-4 mb-6 flex-wrap">
                  <div className="flex items-center text-[#757682] dark:text-slate-400 text-xs">
            ...
            <article className="group bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl dark:border dark:border-slate-800 transition-all duration-500">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-[#444651] dark:text-slate-400 mb-4">
                  Wake up to the sound of waves in our premium coastal-facing
                  room.
                </p>
                <div className="flex gap-4 mb-6 flex-wrap">
                  <div className="flex items-center text-[#757682] dark:text-slate-400 text-xs">
          ...
          <nav className="flex items-center space-x-2">
            <button className="w-10 h-10 flex items-center justify-center rounded-lg border border-[#c5c5d3] dark:border-slate-700 text-[#1a1b21] dark:text-slate-300 hover:bg-[#e9e7ef] dark:hover:bg-slate-800 transition-colors">
              <span className="material-symbols-outlined">
                <LucideChevronLeft className="text-sm" />
              </span>
            </button>
            <button className="w-10 h-10 flex items-center justify-center rounded-lg bg-[#00236f] dark:bg-blue-600 text-white font-bold shadow-md">
              1
            </button>
            <button className="w-10 h-10 flex items-center justify-center rounded-lg text-[#1a1b21] dark:text-slate-300 hover:bg-[#e9e7ef] dark:hover:bg-slate-800 transition-colors">
              2
            </button>
            <button className="w-10 h-10 flex items-center justify-center rounded-lg text-[#1a1b21] dark:text-slate-300 hover:bg-[#e9e7ef] dark:hover:bg-slate-800 transition-colors">
              3
