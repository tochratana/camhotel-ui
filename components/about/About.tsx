...
const members: TeamProfile[] = [
    ...
    },
    {
        ...
        role: "UI Member",
        intro:
            "Vibol works on UI and test the project",
        quote:
    ...
    },
    {
        ...
        role: "UI Member",
        intro:
            "Sothearith works on UI and test the project",
        quote:
    ...
    return (
        <article
            ...
            <div className={`space-y-4 md:col-span-8 ${textOrderClass}`}>
                ...
                <blockquote
                    className="rounded-r-2xl border-l-4 border-[#1f4fb3] bg-[#ecf3ff]/75 px-5 py-4 text-sm italic leading-relaxed text-[#1c3f87] dark:border-blue-400 dark:bg-blue-950/40 dark:text-blue-200">
